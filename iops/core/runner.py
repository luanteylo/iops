...
from iops.util.slurm import Slurm
...
class TestIOR:
    ...
    def __get_ior_command(self, delete_generate_file: bool) -> str:
        ...
        ior_command += f" -o {self.config.filesystem_dir}/test_file.ior"  
        
        return ior_command

    def generate_batch_file(self) -> Path:
        """
...
class Runner:
    ...
    def _run(test: TestIOR) -> None:
        ...
        # Slurm.submit(test.batch_file) # try to figure out how to do
