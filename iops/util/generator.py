...
class Generator:
    ...
    def ini_file(file_name):
        ...
        config_execution['execution'] = {
            ...
            'test_type': 'computing:sequential:one, computing:sequential:shared, filesize:sequential:one, filesize:sequential:shared # The list of tests to be executed. Each test is defined by the following parameters: computing:access:clients_per_node',            
        }
